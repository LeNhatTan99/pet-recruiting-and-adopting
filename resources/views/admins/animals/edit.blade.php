            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Edit animal case</a></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit animal case</h3>
                        </div>
                        <div class="card-body">
                            <form class="create-form" id="quickForm" method="POST" action="{{route('update.animal-case',$data->id)}}" enctype="multipart/form-data">
                                @csrf
